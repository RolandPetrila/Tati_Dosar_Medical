...
```
.Tati/  (10 subfoldere, 29 fișiere root)
├── .claude/  (2 fișiere)
...
│   │   ├── 4361782613845319426  (0.3 KB)
│   ├── .gitignore  (0.0 KB)
│   ├── CACHEDIR.TAG  (0.0 KB)
├── _projects_sync/  (8 fișiere)
│   ├── CONTACTE_MEDICALE.md  (20.2 KB)
│   ├── CONTEXT_MEDICAL.md  (75.0 KB)
│   ├── EXPLICATIE_CONSULT_ONCOLOG_SCENARII.md  (74.5 KB)
│   ├── INDEX.json  (57.4 KB)
│   ├── PROJECTS_PRIMER.md  (8.3 KB)
│   ├── REGULAMENT.md  (11.9 KB)
│   ├── STATUS_SNAPSHOT.md  (26.1 KB)
│   ├── TODO.md  (46.0 KB)
├── assets/  (4 fișiere)
...
├── Documentatie_Initiala/  (20 fișiere)
│   ├── BAZA_CUNOSTINTE.md  (9.4 KB)
│   ├── CHANGELOG.md  (3.7 KB)
│   ├── CONTEXT_MEDICAL.md  (10.1 KB)
│   ├── GLOSAR.md  (10.6 KB)
│   ├── HISTORY_CLAUDE_MD.md  (11.1 KB)
│   ├── INSTALARE.md  (8.3 KB)
│   ├── INSTRUCTIUNI_INITIALE_v1_archived.md  (5.7 KB)
...
│   ├── ROADMAP_POST_2026-04-28.md  (10.2 KB)
│   ├── START.md  (3.8 KB)
...
│   ├── STIL_EXPLICATII_FAMILIE.md  (14.7 KB)
├── Dosar_Medical/  (198 fișiere)
│   ├── arhiva/  (64 fișiere)
│   │   ├── audituri_extragere/  (2 fișiere)
│   │   ├── context_medical_versiuni/  (40 fișiere)
...
│   │   ├── 2026-04-24_re-solicitare-consult-anater.md  (16.0 KB)
│   │   ├── 2026-04-28_draft-mail-anater-rezultat-biopsie.md  (6.2 KB)
│   │   ├── INDEX.md  (8.2 KB)
│   ├── documente_sursa/  (64 fișiere)
│   │   ├── 01_identitate/  (3 fișiere)
│   │   ├── 02_cardiologie_2012/  (3 fișiere)
...
│   │   ├── 2026-05-04_briefing_consult_oncolog.docx  (37.8 KB)
│   │   ├── 2026-05-04_briefing_consult_oncolog.docx.meta.json  (0.6 KB)
│   │   ├── generate_explicatie_scenarii.py  (85.6 KB)
│   │   ├── generate_ghid_cancer_esofagian.py  (80.7 KB)
│   │   ├── generate_reactii_adverse_docx.py  (35.1 KB)
│   ├── 2012-02-17_cardiologie_vichy_stent.json  (18.3 KB)
...
│   ├── 2026-04-17_biopsie_esofagiana_histopatologic.json  (10.6 KB)
...
│   ├── 2026-04-20_ct_torace_abdomen_pelvis.json.meta.json  (2.0 KB)
│   ├── AUDIT_DOCUMENTE_SURSA.md  (1.5 KB)
│   ├── CLAUDE.md  (24.5 KB)
│   ├── CONTACTE_MEDICALE.md  (20.2 KB)
...
│   ├── SYSTEM_HEALTH.json  (3.7 KB)
├── schemas/  (1 fișiere)
│   ├── dosar_medical_v2.json  (3.9 KB)
├── scripts/  (7 fișiere)
...
│   ├── regenerate_structura.py  (11.5 KB)
